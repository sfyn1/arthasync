...
Route::middleware(['auth'])->group(function () {
    ...
    Route::delete('incomes/{id}', [IncomesController::class, 'delete'])->name('incomes.delete');
});
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::delete('expenses/{id}', [ExpensesController::class, 'delete'])->name('expenses.delete');
});
